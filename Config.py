...
def parse_arguments(args=None):
    ...
    parser.add_argument("--algo_type", type=str, default='FEDAVG', choices=['FEDPROX', 'PROPOSED_heterogen', 'PROPOSED_homogen', 'FEDAVG', 'FEDMD_homogen', 'FEDMD_heterogen', 'scaffold'], help='type of training algorithm')
    ...
    parser.add_argument("--serverloader_type", type=str, default="fedmd", choices=["fedmd", "1090"], help="Number of rounds")
    parser.add_argument("--BLIP", type=bool, default=True, help="Flag to specify if we are using BLIP")
